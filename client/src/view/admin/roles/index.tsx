  ...
  return (
    <div className="space-y-6">
      ...
      <Alert
        ...
        type="info"
        message={
          <span className="font-medium">Work in progress — stay tuned</span>
        }
        description={
          <span className="text-gray-600">
            We’re still building this section. Coming soon: roles list,
            create/edit role modal, permission matrix, and user assignment.
          </span>
        }
      ...
      <div className="rounded-2xl border border-dashed p-10 text-center bg-white mt-10 ">
        ...
        <p className="mt-2 text-gray-500">
          While we wire up APIs and UI, here’s a placeholder. You can still use
          the toolbar above to export or refresh.
        </p>
      </div>
