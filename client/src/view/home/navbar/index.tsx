...
export default function Navbar() {
    ...
    // Lock page scroll when menu open + close on ESC + focus management
    useEffect(() => {
        ...
        <header
            className={`fixed top-0 left-0 w-full z-[999] transition-all duration-300 text-white ${
                isScroll
                    ...
                    : "bg-[#0a131d] lg:bg-transparent py-4 sm:py-5 lg:py-8"
            }`}
            role="banner"
        >
            ...
            <aside
                id="mobile-menu"
                className={`fixed top-0 left-0 z-[999] h-[100dvh] w-[80vw] max-w-72 bg-[#0a131d]/95 backdrop-blur-md shadow-xl transform transition-transform duration-300 ease-in-out lg:hidden px-5 pt-[calc(env(safe-area-inset-top)+12px)] ${
