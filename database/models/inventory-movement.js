    ...
    InventoryMovement.init(
        {
            ...
            movementType: { type: DataTypes.ENUM("purchase","sale","adjustment","return"), allowNull: false },
            quantity: { type: DataTypes.DECIMAL(18,2), allowNull: false },
            relatedEntityType: { type: DataTypes.ENUM("Purchase","Sale","Manual"), allowNull: true },
